...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--name', type=str, default='sarlabel', help='name of the experiment. It decides where to store samples and models')
        ...
        # for setting inputs
        parser.add_argument('--dataroot', type=str, default='D:/Derrame_Data/OilDatasetPatches512v2')
