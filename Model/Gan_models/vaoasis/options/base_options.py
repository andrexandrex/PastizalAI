...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--pad', type=str, default='zero', help='padding type', choices=['zero', 'reflect'])
        ...
        parser.add_argument('--width', type=int, default=0, help='the height in every scale, it will be rewritten')
        ...
        # for setting inputs
        parser.add_argument('--dataroot', type=str, default='./datos_sar')
        parser.add_argument('--dataset_mode', type=str, default='sarlabel')
        ...
        parser.add_argument('--norm_mode', type=str, default='spade_variation', help='[spade | clade | variation]')
