...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        #parser.add_argument('--num_upsampling_layers', type=str, default='more' , help='saves results here.')
        ...
        parser.add_argument('--fid_stats_path', type=str, default='datasets/train_mu_si',
                    help='Path to directory containing m.npy and s.npy for FID computation')
        self.isTrain = True
        return parser
