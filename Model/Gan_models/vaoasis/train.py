...
def main():
    ...
    if opt.train_eval:
        ...
        mu_np_root = os.path.join(val_opt.fid_stats_path, val_opt.dataset_mode,'m.npy')
        st_np_root = os.path.join(val_opt.fid_stats_path, val_opt.dataset_mode,'s.npy')
    ...
    for epoch in iter_counter.training_epochs():
        ...
        if epoch % val_opt.eval_epoch_freq == 0: #and val_opt.train_eval and epoch > 50
            ...
            m1, s1 = fid_score.calculate_activation_statistics(files, eval_model, 1, val_opt.eval_dims, True, images=None)
            fid_value = fid_score.calculate_frechet_distance(m0, s0, m1, s1)
