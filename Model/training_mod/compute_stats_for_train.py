...
# Filtra los archivos para obtener solo imágenes
def filter_images(file_list):
    valid_extensions = ['.png', '.jpg', '.jpeg', '.tiff', '.bmp', '.gif']  # Añade más extensiones si es necesario
    return [file for file in file_list if os.path.splitext(file)[1].lower() in valid_extensions]

def compute_stats(FLAGS):
    list_images = sorted(filter_images(os.listdir(FLAGS.dir_images)))
...
def main():
    ...
    dir_images = "/content/drive/MyDrive/CIMA2023/Documentos2023/Proyectos/Proy1-ImagenesEspectrales/data/imagenes/OilDataset/"
    ...
    parser.add_argument(
        ...
        default=file_json,
        type=str,
        help="H:/AndreJuarez/Code_OilSpill",
    )
    parser.add_argument(
        "--dir_images",
        default=dir_images,
        type=str,
        help="J:/Mi unidad/CIMA2023/Documentos2023/Proyectos/Proy1-ImagenesEspectrales/data/imagenes/OilDataset/train/images",
    )
